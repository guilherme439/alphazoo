...
@ray.remote
class RpcInferenceServer(IInferenceServer):
    """
    Remote Procedure Call inference server. Ray actor that serves inference to
    ...
    @override
    def stop(self) -> None:
        self._request_queue.put(RpcInferenceServer._STOP_REQUESTED)
    ...
    def _stop_requested(self, item: Any) -> bool:
        return item is RpcInferenceServer._STOP_REQUESTED
