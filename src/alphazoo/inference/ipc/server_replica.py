...
class IpcInferenceReplica(IInferenceReplica):
    """
    Inter-Process Communication inference replica. Ray actor that serves
        ...
        while True:
            ...
            for fd, _ in events:
                if fd == self._stop_read:
                    self._request_queue.put(IpcInferenceReplica._STOP_REQUESTED)
                    return
    ...
    def _inference_stage(self) -> None:
        ...
        while True:
            ...
            if stop_requested:
                break
        self._result_queue.put(IpcInferenceReplica._STOP_REQUESTED)
    ...
    def _stop_requested(self, item: Any) -> bool:
        return item is IpcInferenceReplica._STOP_REQUESTED
